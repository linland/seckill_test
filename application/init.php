...
switch(ENV) {
    ...
    case 'TEST':
        $logFile = APPLICATION_PATH.'/log/php/'.CUR_DATE.'.log';
...
define('FUNC_PATH',    APPLICATION_PATH.'/application/function');
...
define('SECKILL_EVENTS', 'SECKILL_EVENTS');
define('SECKILL_GOODS', 'SECKILL_GOODS');
/*
