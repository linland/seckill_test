...
class Rdb
{
    ...
    {
        return $this->handle->watch( $key );
    }

    public function multi( )
    {
        return $this->handle->multi();
    }
    ...
    {
        return $this->handle->keys( $pattern );
    }
	/**
	 *    lpush
	 */
    ...
    public function lRem( $key, $value, $count ) {
        return $this->handle->lRem($key, $value, $count);
    }
	...
	{
		return $this->handle->hSet($key, $hashKey, $value);
	}

    public function hMset($key, $hashKeys){
        return $this->handle->hmset($key, $hashKeys);
    }

    public function hMGet( $key, $hashKeys ) {
        return $this->handle->hmget($key, $hashKeys);
    }
